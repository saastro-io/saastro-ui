---
title: Introduction
description: Production-ready landing page blocks for Astro, built with shadcn/ui.
...
Blocks are complete, self-contained landing page sections — hero sections, feature grids, pricing tables, testimonials, and more. Each block is a React component that uses standard shadcn/ui primitives.
...
Individual UI primitives (Button, Card, Badge) are already solved by [shadcn/ui](https://ui.shadcn.com). What takes time is composing them into complete page sections with proper layout, spacing, and responsive behavior.
